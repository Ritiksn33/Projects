...
public class TransacAdapter extends ArrayAdapter<Transition> {
    private Context mContext;
    int mResource;
    public TransacAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Transition> objects) {
